...
superheat <- function(X,
                      ...
                      legend.breaks = NULL,
                      legend.vspace = 0.1,
                      legend.text.family = 'Times New Roman',
                      ...
                      bottom.label.text.family = 'Times New Roman',
                      left.label.text.family = 'Times New Roman',

                      column.title = NULL,
                      row.title = NULL,
                      column.title.size = 5,
                      row.title.size = 5,
                      column.title.family = 'Times New Roman',
                      row.title.family = 'Times New Roman',
